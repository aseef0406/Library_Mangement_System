...
public class Loading extends javax.swing.JFrame implements Runnable{
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 204, 51), 4, true));

        jProgressBar1.setStringPainted(true);

        jLabel1.setFont(new java.awt.Font("Old English Text MT", 1, 48)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 255));
        jLabel1.setText("Opening Library");
        ...
        setSize(new java.awt.Dimension(447, 243));
